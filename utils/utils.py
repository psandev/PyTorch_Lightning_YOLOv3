...
def ap_per_class(tp, obj_score, pred_cls, target_cls):
    """ Compute the average precision, given the recall and precision curves.
    Source: https://github.com/rafaelpadilla/Object-Detection-Metrics.
    # Arguments
        tp:    True positives (list).
        obj_score:  Objectness value from 0-1 (list).
    ...
    # Sort by objectness
    i = np.argsort(-obj_score)
    tp, obj_score, pred_cls = tp[i], obj_score[i], pred_cls[i]
