...
def evaluate(model, path, iou_thres, conf_thres, nms_thres, img_size, batch_size, cache_path, cache):
    model.eval()
...
def evaluate_batch(imgs, targets, outputs, labels, sample_metrics,iou_thres, conf_thres, nms_thres, img_size):
    # model.eval()
    #
    # # Get dataloader
